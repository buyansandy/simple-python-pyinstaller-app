node {
    ...
    stage('Deploy') {
		...
		//	sh 'scp -vvv -i /home/jenkins/pem/ec2-cicd-phy-aks.pem dist/add2vals ubuntu@ec2-13-229-83-98.ap-southeast-1.compute.amazonaws.com:/home/ubuntu/'    
		//	sh 'scp -vvv -i /home/Documents/Dicoding/DevOps-2024/ec2-cicd-phy-aks.pem dist/add2vals ubuntu@ec2-13-229-83-98.ap-southeast-1.compute.amazonaws.com:/home/ubuntu/'    
        // Run the app in EC2
		...
		//	sh 'ssh -vvv -i /home/Documents/Dicoding/DevOps-2024/ec2-cicd-phy-aks.pem ubuntu@ec2-13-229-83-98.ap-southeast-1.compute.amazonaws.com "chmod a+x /home/ubuntu/add2vals && /home/ubuntu/./add2vals 3 4"'
			sh 'ssh -vvv -i /Users/maste/Documents/Dicoding/DevOps-2024/ec2-cicd-phy-aks.pem ubuntu@ec2-13-229-83-98.ap-southeast-1.compute.amazonaws.com'
            sleep time: 1, unit: 'MINUTES'
        }
    }
}